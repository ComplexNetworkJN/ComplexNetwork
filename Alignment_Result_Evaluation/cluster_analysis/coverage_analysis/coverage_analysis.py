...
_total=set(cat.values()) | set(cow.values()) | set(dog.values()) | set(guinea_pig.values()) | set(horse.values()) | set(human.values()) | set(mouse.values()) | set(pig.values()) | set(rabbit.values()) | set(rat.values()) | set(sheep.values())
...
if __name__=='__main__':
    ...
    for no,_sum in cluster_count.items():
        print(f"{no}\tspecies clusters number :\t{_sum}")
